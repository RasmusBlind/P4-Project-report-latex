...
\section{Results}
	...
	\subsection{Mel Frequency Cepstrum Coefficients}
		...
		% BEST: 5ms 2ms K=7, K=8
		% WORST: 20ms 10ms K=2, although it still has better k precision than some (e.g. K=4, K=6). It has the worst s precision of all, but a few have similar hh precision (e.g. K=1, K=6)
		% CHI: All significant for all configurations of MFCC
